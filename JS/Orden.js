...
if (tipoDeMetodo == "Burbu"){
    ...
    alert('La ordenacion con Burbuja es: ' + a.join(', '));
    ...
    if (b.length <= 0) {
        ...
        alert('La ordenacion con QuickSort es: ' + Ordenado.join(', '));
     }
            ...
            alert('La ordenacion con ShellShort es: ' + arrayNumeros.join(', '));
            ...
            const miSecuencia = [4,2,1,3,5,7,9,6];
